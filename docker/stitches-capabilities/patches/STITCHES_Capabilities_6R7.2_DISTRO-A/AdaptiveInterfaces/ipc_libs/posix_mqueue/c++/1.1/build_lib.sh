...
FILE=StitchesIPCPosixMQueue
rm libstitches_ipc_posix_mqueue.a &> /dev/null
g++ -fPIC $DEFS -O2 -std=c++98 -Wall -pedantic -o ./bin/$FILE.o -c src/$FILE.cpp -I./include -I./../../../CommonAPI/c++/include 
if [ $? -ne 0 ];
then
  exit 1
fi
ar rs libstitches_ipc_posix_mqueue.a ./bin/*.o 
if [ $? -ne 0 ];
then
  exit 1
fi
